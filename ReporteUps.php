...
// Cabecera de página
        function Header()
        {
            ...
            $this->Cell(80);
            // Título
            $this->Cell(200,10,'REPORTE UNIDADES DE POTENCIA',0,1,"L");
            // Salto de línea
            $this->Ln(20);
        ...
        //      Inicio del cuerpo del pdf encabezado del reporte
            ...
            $this -> cell(40, 10, 'PLACA', 1, 0, 'C', 1);
            $this -> cell(40, 10, 'INGRESO', 1, 0, 'C', 1);
            $this -> cell(40, 10, 'UBICACION', 1, 0, 'C', 1);
            $this -> cell(40, 10, 'MARCA', 1, 0, 'C', 1);
            $this -> cell(40, 10, 'MODELO', 1, 0, 'C', 1);
            $this -> cell(40, 10, 'OBSERVACIONES', 1, 1, 'C', 1);
...
while ($row = $resultado -> fetch_assoc()) 
            {
                ...
                $pdf -> cell(15, 10, $row['Consecutivo'], 1, 0, 'C', 0);
                $pdf -> cell(40, 10, $row['Placa'], 1, 0, 'C', 0);
                $pdf -> cell(40, 10, $row['Fingreso'], 1, 0, 'C', 0);
